class Book {
  ...
  factory Book.fromMap(Map<String, dynamic> map) {
    return Book(
      id: map[columnId] is int ? map[columnId] as int : int.parse(map[columnId].toString()),
      coverImage: map[columnCover],
      judul: map[columnJudul],
      genre: map[columnGenre],
      hargaPinjam: map[columnHargaPinjam] is double
          ? map[columnHargaPinjam] as double
          : double.tryParse(map[columnHargaPinjam].toString()) ?? 0.0,
